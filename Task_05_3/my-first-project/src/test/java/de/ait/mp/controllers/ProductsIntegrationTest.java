...
class ProductsIntegrationTest {
    ...
    public class PostProduct{
        ...
        @Test
        public void return_400_status_when_null_price() throws Exception {
            mockMvc.perform(post("/api/products")
                            .contentType("application/json")
                            .content("{\n" +
                                    "  \"productName\": \"new product5\",\n" +
    ...
    public class GetProduct{
        ...
        @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
        @Sql(scripts = {"/sql/data.sql"})
        public void return_status_200_product_by_id() throws Exception {
        ...
        @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
        @Sql(scripts = {"/sql/data.sql"})
        public void return_status_404_product_by_id_not_found() throws Exception {
