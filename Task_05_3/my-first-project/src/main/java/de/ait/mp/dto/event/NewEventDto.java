...
@Data
@Schema(name = "Event", description = "information for adding a new event")
public class NewEventDto {

    @Schema(description = "ID of an existing event, if specified - other fields do not need to be specified", example = "1")
