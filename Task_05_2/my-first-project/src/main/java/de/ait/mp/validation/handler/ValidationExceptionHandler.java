package de.ait.mp.validation.handler;

import de.ait.mp.validation.dto.ValidationErrorDto;
...
@ExceptionHandler(value = MethodArgumentNotValidException.class)
    ...
    for(ObjectError error:errors){
        ...
        ValidationErrorDto errorDto = ValidationErrorDto.builder()
            ...
            //    .rejectedValue(fieldError.getRejectedValue().toString())  below check null
